...
layout: article
permalink: /lab/es/ip-orchestra.html
...
### Programación
11 de septiembre: Dia 1 de taller. <br>
12 de septiembre: Día 2 de taller. <br>
13 de septiembre: Exposición <br>
  ...
  <article class="cell cell--bordered cell--12">
    <div class="hero hero--center hero--light" style='background-color: #white;'>
      <div class="hero__content">
        ...
        <p>Por favor, desactiva el silencio de tu dispositivo y presiona el botón de PLAY ▶️. Ajusta el sonido moviendo los KNOBS XYZ hacia arriba o hacia abajo hasta que te guste lo que escuchas. Si deseas volver al sonido original, presiona los botones hexagonales ⬢ para restablecer los KNOBS en su equilibrio.</p>
      </div>
    </div>
    <div class="hero hero--center hero--light" style='background-color: #white;'>
      <div class="hero__content">
...
<div class="grid">
  <div class="cell cell--bordered cell--12">
    <!-- Sección 1: Tradición Innovadora -->
    <div class="hero hero--center hero--light" style='background-color: #white;'>
      <div class="hero__content">
        <h3>Tradición Innovadora</h3>
        <img src="https://collect.maar.world/img/docs/int-players/maar-world-banner-ovni.jpg" alt="Tradición Innovadora" style="max-width: 100%; height: auto; margin-top: 20px;">
        <p>Descubre los diferentes efectos de las cartas como si estuvieras ajustando la experiencia de una nave espacial.</p>
      </div>
    </div>
    <!-- Sección 2: Una Armonía Extendida de las Esferas -->
    <div class="hero hero--center hero--light" style='background-color: #white;'>
      <div class="hero__content">
        <h3>Una Armonía Extendida de las Esferas</h3>
        <img src="https://collect.maar.world/img/docs/int-players/Planetary_Musical_Scales_from_Harmony_of_the_Worlds.jpg" alt="Armonía de las Esferas" style="max-width: 100%; height: auto; margin-top: 20px;">
        <p>Sincroniza tu remix con el movimiento del sistema estelar Kepler-47. Es como mezclar paisajes sonoros con un toque de polvo de estrellas, abriendo un nuevo espectro de posibilidades para improvisar con el cosmos.</p>
      </div>
    </div>
  </div>
</div>
