  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    function loadItems(page) {
      ...
      for (let i = startIndex; i < endIndex; i++) {
        ...
        container.setAttribute('data-src', `https://player.maar.world:5173/?trackId=${trackId}&s=0`);
        ...
        const info = `
          ...
          <br>
          <a href="https://player.maar.world:5173/?trackId=${trackId}&s=0" rel="Maar World Player" target="_blank">Play full screen</a>
          <br>
